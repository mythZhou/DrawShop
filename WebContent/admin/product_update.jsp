    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form  action="/shop/ProductServlet?method=update" method="post" enctype="multipart/form-data">
						 ...
						 <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="name" class="field">
                                    <input  name="filename" class="gui-input" placeholder="图片" type="file" value="上传图片"/>
                                </label>
                            </div>
                        </div>						
						<div class="section row">
							...
							<div class="col-md-6">
								<label for="address" class="field">
									<input  name="description" class="gui-input" placeholder="描述" type="text" value="${product.description }"/>
								</label>
							</div>
                        </div>
