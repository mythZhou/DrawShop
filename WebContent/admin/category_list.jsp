...
<script type="text/javascript">
	function saveUI(){
		window.location.href="/shop/CategoryServlet?method=saveUI";
	}
</script>
                    ...
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <tbody>
                            ...
                            <tr class="message-unread">
                                ...
                                <td>
                                    <a href="/shop/CategoryServlet?method=edit&cid=${category.cid }">编辑</a>
                                    <a href="/shop/CategoryServlet?method=delete&cid=${category.cid }">删除</a>
                                </td>
                            </tr>
                        	</c:forEach>
                        </tbody>
