        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <!-- 
                	文件上传的要素：
                	1.表单提交方式必须是post
                	2.表单项中必须由文件上传项，必须有name和对应的值
                	3.表单的enctype属性需要设置为multipart/form-data
                 -->
                <form id="admin-form" name="addForm" action="/shop/ProductServlet?method=save" method="post" enctype="multipart/form-data">
                    <div class="panel-body bg-light">
						...
						<div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="sn" class="field">
                                    <input  name="price" class="gui-input" placeholder="价格" type="text" />
                        ...
                        <div class="section row">
                            ...
                            <div class="col-md-6">
                                <label for="sn" class="field">
                                    <input  name="author" class="gui-input" placeholder="作者" type="text" />
