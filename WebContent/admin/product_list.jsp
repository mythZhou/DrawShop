...
<script type="text/javascript">
	function saveUI() {
		window.location.href="/shop/ProductServlet?method=saveUI";
	}
</script>
                    ...
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <c:forEach items="${list }" var="product">
                            <tr class="message-unread">
                                ...
                                <td>
                                    <a href="/shop/ProductServlet?method=edit&pid=${product.pid }">编辑</a>
                                    <a href="/shop/ProductServlet?method=delete&pid=${product.pid }">删除</a>
                                </td>
                            </tr>
						</c:forEach>
                        </tbody>
